...
public class Latihan2 {
	...
	public static void main(String[] args) {
		//testing
		String rd = "UNIVERSITAS SULAWESI BARAT";
		System.out.println("Bentuk Plaintextnya adalah	:"+rd);
		
		String id = encript(rd);
		System.out.println("Bentuk Enkripsinya adalah	:"+id);
		
		String rd1 = descript(id);
		System.out.println("Bentuk Dekripsinya adalah	:"+rd1);                     
